...
async def on_ready():
    ...
    #await bot.change_presence(activity=discord.Game("with the dog inside"))
    await bot.get_channel(1045937547597053982).send("I am alive and am capable of feeling.");
    print("Bot is ready")
...
async def main():
    ...
    await bot.start('MTAzNDYwOTY5NDUwMjgzNDE5Ng.GM-rw9.GxlpjDH6DKv8nbu2OZgaswwgV77TQUKhchlw18')
asyncio.run(main())
